...
dvc stage add --force -n featurize -p featurize.max_features,featurize.ngrams -d src/featurization.py -d data/prepared -o data/features ^ python src/featurization.py data/prepared data/features
